# sniplicity_py
A python version of sniplicity, all future development will be here
...
1. read all `md`, `mdown`, `markdown`, `html`, `htm` and `txt` files found in the `in` directory
2. process them (markdown is first converted to html)
3. save compiled files to the `out` directory
4. handles recursive sub-directories
